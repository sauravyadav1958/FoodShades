...
public class TinyDB {
    //    storing simple key-value data like user preferences, configuration settings,
//    or simple data like flags (e.g., whether it's the user's first time opening the app).
    private SharedPreferences preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    public TinyDB(Context appContext) {
        // getDefaultSharedPreferences(): single default SharedPreferences instance
