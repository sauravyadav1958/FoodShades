...
public class ChangeLocationActivity extends AppCompatActivity implements
    ...
    private void init() {
       ...
       /* mTotalAmount = getIntent().getStringExtra("TOTAL_AMOUNT");
        ...
        textView.setText(String.format(
                "%s", getIntent().getStringExtra("total")
        ));
    }
    ...
    private void setLocation(double latitude, double longitude) {
        ...
        mSaveLocationBtn.setOnClickListener(view -> {
            ...
            db.collection("UserList").add(updateLocMap).addOnCompleteListener(task -> {
            });
            db.collection("UserList").get().addOnCompleteListener(task -> {
            });
